...
int main() {
	...
	if (signal == 0) {
		...
		testcase
				...
				.CHECK_OK(istringstream("29[]") >> b)
				.CHECK_OK(istringstream("2g]") >> a)
				.CHECK_OK(istringstream("50[kgg]") >> b)
				.CHECK_OK(istringstream("152.2kg") >> a)
				.CHECK_OK(istringstream("13.2[to n]") >> a)
